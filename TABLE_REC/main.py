...
from .table_infer.inference_onnx import TableLineRecognitionV3
...
default_model_path = cur_dir / "models" / "onnx_model.onnx"

class WiredTableRecognition:
    def __init__(self, table_model_path: Union[str, Path] = None):
        self.load_img = LoadImage()
        self.table_line_rec = TableLineRecognitionV3(str(default_model_path))
    ...
    def __call__(
        ...
        t = time.time()
        table_res, logi_points, polygons = self.table_recover(polygons)
