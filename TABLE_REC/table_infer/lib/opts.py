...
class opts(object):
  def __init__(self, load_model):
    ...
    self.parser.add_argument('--demo', default='../input_images/test', 
                             help='path to image/ image folders/ video. '
                                  'or "webcam"')
    self.parser.add_argument('--demo_name', default='demo_wired', 
                             help='path to image/ image folders/ video. '
                                  'or "webcam"')
    self.parser.add_argument('--output_dir', default='../data/table/', 
                             help='path to image/ image folders/ video. '
                                  'or "webcam"')   
    self.parser.add_argument('--demo_dir', default='../visualization_wired_test/', 
    ...
    self.parser.add_argument('--vis_thresh_corner', type=float, default=0.3,
    ...
    self.parser.add_argument('--wiz_4ps', action='store_true', default=True, 
                             help='whether to use the feature of the four corner points. ')
    self.parser.add_argument('--wiz_stacking', action='store_true', default=True, 
    ...
    self.parser.add_argument('--tsfm_layers', type=int, default=3,
    ...
    self.parser.add_argument('--wiz_pairloss', action='store_true', default=True, 
    ...
    self.parser.add_argument('--nms', action='store_false', default=True,
    ...
    self.parser.add_argument('--keep_res', action='store_true',
                             help='keep the original resolution'
                                  ' during validation.')
    self.parser.add_argument('--wiz_rev',  action='store_true', default=True,
                             help='using the pasing-grouping mechanism for wired table only. ')
    self.parser.add_argument('--wiz_detect',  action='store_true', default=True, 
    ...
    self.parser.add_argument('--no_color_aug', action='store_true',
                             help='not use the color augmenation '
                                  'from CornerNet')
    self.parser.add_argument('--MK', default=1000,
    ...
    self.parser.add_argument('--scores_thresh', type=float, default=0.2,
  ...
  def parse(self, args=''):
    ...
    opt.load_model = self.load_model
  ...
  def init(self, args=''):
    default_dataset_info = {
      'ctdet': {'default_resolution': [1024, 1024], 'num_classes': 2, 
                ...
                'dataset': 'table'},
      'ctdet_sim': {'default_resolution': [1024, 1024], 'num_classes': 2, 
                'mean': [0.408, 0.447, 0.470], 'std': [0.289, 0.274, 0.278],
                'dataset': 'table'},
